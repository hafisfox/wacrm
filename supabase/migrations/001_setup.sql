...
create table if not exists salu.customer_profiles (
  ...
  data_sharing_consent_version text not null default '',
  data_sharing_consent_text text not null default '',
  data_sharing_consent_accepted_at timestamptz,
...
begin
  ...
  insert into salu.customer_profiles (
    ...
    last_seen_at, data_sharing_consent, data_sharing_consent_version,
...
-- Source: 027_message_templates_account_unique.sql
...
-- Source: 028_salu_consent_audit_fields.sql
