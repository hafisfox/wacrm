...
//   on the list falls through to the first allowed host with a loud
//   console.warn. Operators who care about this attack
//   surface should set this to their canonical hostnames; everyone
//   else gets today's permissive behavior.
//
// This Salu dashboard should never publish links to the upstream
// template marketing site; when all else fails locally, use localhost.
...
function getBaseUrl(request: Request): string {
  ...
  if (allowList?.[0]) return `https://${allowList[0]}`;
