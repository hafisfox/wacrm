    ...
    >
      ...
      <div className="group/actions relative max-w-[75%] min-w-0">
        ...
        <div
          ...
          className={cn(
            'border-chat-line-strong bg-chat-panel/95 absolute -top-3 z-10 flex h-7 items-center gap-0.5 rounded-full border px-1 shadow-md backdrop-blur-sm transition-opacity',
        ...
        >
          <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
            <PopoverTrigger
              className="text-chat-ink-2 hover:bg-chat-surface-strong hover:text-chat-ink flex h-5 w-5 items-center justify-center rounded-full"
              aria-label="React"
            >
            ...
            >
              {QUICK_EMOJIS.map((e) => (
                <button
                  ...
                  className="hover:bg-chat-surface-strong flex h-8 w-8 items-center justify-center rounded-full text-lg leading-none transition-transform hover:scale-125"
